...
print("<html><body>")
print("<h1>Deposit Screen</h1>")
print("<form action='/cgi-bin/deposit.py'  method='post'>")
...
for line in f:
    for w in line.split():
        if str(w)==str(ssn):
            ...
            print("<form action='/cgi-bin/deposit.py'  method='post'>")
            print("data: <textarea hidden name='data'  rows='2' cols='40'>"+line+"</textarea></br>")
...
if form.getvalue('deposit'):
    print("<h2>Amount deposited successfully</h2>")
